...
### 4. Gestor de Rifas Pro - Raffle Management
- **Descripción**: Plataforma integral para la administración profesional de sorteos con automatización de ventas y auditoría.
- **Tecnologías**: Next.js 15, React, TypeScript, Firebase (Firestore & Auth), Tailwind CSS.
- **Demo**: [https://gestor-de-rifas.vercel.app/](https://gestor-de-rifas.vercel.app/)

### 5. Plataforma de Rifas Online (White-Label)
